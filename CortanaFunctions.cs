      ...
      public void controls()
        {
            ...
            x.webviewXX.Source = new Uri("https://isiolomega.com/Mega/PortalsUI/androidsmartsappsregisterclientsapks.aspx");
        ...
        private readonly static IReadOnlyDictionary<string, Delegate> vcdLookup = new Dictionary<string, Delegate>{
            ...
            */
            ...
            {"OpenWebsite", (Action)(async () => {
                ...
                //Order Voice to Continue here**
                MainPage xx=new MainPage();

                //End continue voice**
                 await WebView.ClearTemporaryWebDataAsync();

                  xx.webviewXX.Source = new Uri("https://isiolomega.com/Mega/PortalsUI/androidsmartsappsregisterclientsapks.aspx");
        ...
        */
        public static async void RegisterVCD()
        {
            StorageFile vcd = await Package.Current.InstalledLocation.GetFileAsync(
                @"CustomeVoiceCommandDefination.xml");
